...
driver.get("https://www.globalsqa.com/demo-site/frames-and-windows/#iFrame")
f_element=driver.find_element(By.NAME,"globalSqa")
driver.switch_to.frame(f_element)
phone_number=driver.find_element(By.XPATH,"//div[@class='header_phone']").text
print("Phone Number=",phone_number)
email_id=driver.find_element(By.XPATH,"//div[@class='header_mail']").text
print("Contact_detail=",email_id)
time.sleep(10)
driver.find_element(By.ID,"s").send_keys("Selenium")
driver.find_element(By.XPATH, "//button[@class='button_search']").click()
#print(search_box)
time.sleep(10)
#driver.find_element(driver.find_element(By.XPATH,"//button[@class='button_search']").send_keys("Selenium")
driver.switch_to.default_content()
driver.close()
