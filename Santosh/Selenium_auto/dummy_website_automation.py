...
print(first_name)
driver.find_element(By.XPATH,"(//input[@name='firstname'])[1]").send_keys('santoshkumar')

last_name=driver.find_element(By.XPATH,"//span[text()='    Last Name     ']").text
print(last_name)
driver.find_element(By.XPATH,"(//input[@name='firstname'])[2]").send_keys('wadikar')
...
print(dest_city)
driver.find_element(By.XPATH,"//input[@name='destcity']").send_keys('Nanded')
...
print(contact_form)
driver.find_element(By.XPATH,"(//input[@class='contact-form-name'])[1]").send_keys('Santos')
driver.find_element(By.XPATH,"(//input[@class='contact-form-email'])[1]").send_keys("santosh@gmail.com")
