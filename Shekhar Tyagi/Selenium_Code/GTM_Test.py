...
time.sleep(1)
driver.find_element(By.ID,"street_address1").send_keys("H/s No 18, CP, New Delhi, 110011")
time.sleep(1)
driver.find_element(By.ID,"street_address2").send_keys("Near India Gate, India")
time.sleep(5)
driver.close()
