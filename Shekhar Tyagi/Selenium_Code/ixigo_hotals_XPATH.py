...
driver.find_element(By.XPATH,"(//input[@class='w-full focus:outline-none bg-transparent h6 font-medium truncate InputDesktop_input__8ZbNC'])[1]").send_keys("Bangalore")
...
driver.find_element(By.XPATH,"//p[text() = 'Bengaluru']").click()
#driver.find_element(By.XPATH," //p[normalize-space()='Bengaluru']").click()
time.sleep(1)

driver.find_element(By.XPATH,"(//button[@type='button'])[70]").click()
